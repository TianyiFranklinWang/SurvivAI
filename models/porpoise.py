...
class BilinearFusion(nn.Module):
    def __init__(self, skip=0, use_bilinear=0, gate1=1, gate2=1, dim1=128, dim2=128, scale_dim1=1, scale_dim2=1,
                 mmhid=256, dropout_rate=0.25):
...
class PorpoiseMMF(nn.Module):
    def __init__(self,
        ...
        self.size_dict_path = {"small": [path_input_dim, 512, 256], "big": [1024, 512, 384],
                               "eva_big": [1408, 896, 768], "vit_s_small": [768, 512, 256],
                               "hipt_small": [384, 192, 192]}
        self.size_dict_omic = {'small': [256, 256], "eva_big": [768, 768], "vit_s_small": [256, 256],
                               "hipt_small": [192, 192]}
        ...
        if self.fusion is not None:
            ...
            hidden = self.size_dict_omic[size_arg]
            ...
            if self.fusion == 'concat':
                ...
                self.mm = BilinearFusion(dim1=size[2], dim2=size[2], scale_dim1=scale_dim1, gate1=gate_path,
                                         scale_dim2=scale_dim2, gate2=gate_omic, skip=skip, mmhid=size[2])
            elif self.fusion == 'lrb':
                self.lr_bilinear_fusion = LRBilinearFusion(dim1=256, dim2=256, scale_dim1=scale_dim1, gate1=gate_path,
                                                           scale_dim2=scale_dim2, gate2=gate_omic)
                self.mm = self.lr_bilinear_fusion
            else:
                self.mm = None
    ...
    def forward(self, x_path, x_omic):
        ...
        if self.fusion == 'bilinear':
            h_mm = self.mm(h_path, h_omic.unsqueeze(0))
...
def porpoise_mmf(**kwargs):
    ...
    return PorpoiseMMF(**filtered_kwargs)
